...
var _user$project$Request_Helper$Success = function (a) {
	return {ctor: 'Success', _0: a};
};
var _user$project$Request_Helper$Failure = function (a) {
	return {ctor: 'Failure', _0: a};
};
var _user$project$Request_Helper$resultToMessage = function (result) {
	var _p0 = result;
	if (_p0.ctor === 'Ok') {
		return _user$project$Request_Helper$Success(_p0._0);
	} else {
		return _user$project$Request_Helper$Failure(_p0._0);
	}
};
var _user$project$Request_Helper$sendReq = _elm_lang$http$Http$send(_user$project$Request_Helper$resultToMessage);
var _user$project$Request_Helper$get = F3(
	function (apiUrl, translation, decoder) {
		return A2(
...
var _user$project$Model_UserDecoder$user = A2(
	_elm_lang$core$Json_Decode$field,
	'data',
	A4(_elm_lang$core$Json_Decode$map3, _user$project$Model_User$Schema, _user$project$Model_UserDecoder$id, _user$project$Model_UserDecoder$name, _user$project$Model_UserDecoder$email));
var _user$project$Model_UserDecoder$listUsers = A2(
	_elm_lang$core$Json_Decode$field,
	'data',
	_elm_lang$core$Json_Decode$list(
		A4(_elm_lang$core$Json_Decode$map3, _user$project$Model_User$Schema, _user$project$Model_UserDecoder$id, _user$project$Model_UserDecoder$name, _user$project$Model_UserDecoder$email)));

var _user$project$Model_UserEncoder$email = function (value) {
	return {
		ctor: '_Tuple2',
		_0: 'email',
...
var _user$project$Model_UserEncoder$name = function (value) {
	return {
		ctor: '_Tuple2',
		_0: 'name',
		_1: _elm_lang$core$Json_Encode$string(value)
...
var _user$project$Request_UserData$index = A3(_user$project$Request_Helper$get, 'http://localhost:4000/api/users', _user$project$Request_UserData$Index, _user$project$Model_UserDecoder$listUsers);
var _user$project$Request_UserData$Show = function (a) {
	return {ctor: 'Show', _0: a};
};
var _user$project$Request_UserData$show = function (id) {
	return A3(
		...
		_user$project$Request_UserData$Show,
		_user$project$Model_UserDecoder$user);
};

var _user$project$Model_Post$body = F2(
	function (post, newBody) {
		return _elm_lang$core$Native_Utils.update(
			post,
			{body: newBody});
	});
var _user$project$Model_Post$title = F2(
	function (post, newTitle) {
		return _elm_lang$core$Native_Utils.update(
			post,
			{title: newTitle});
	});
...
var _user$project$Model$updateListPosts = F2(
	function (model, listPosts) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{listPosts: listPosts});
	});
var _user$project$Model$updatePost = F2(
	function (model, post) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{post: post});
	});
var _user$project$Model$updateUser = F2(
	function (model, user) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{user: user});
...
var _user$project$Model$Model = F3(
	function (a, b, c) {
		return {user: a, post: b, listPosts: c};
	});
var _user$project$Model$new = A3(
	_user$project$Model$Model,
	_user$project$Model_User$new,
	_user$project$Model_Post$new,
	{ctor: '[]'});

var _user$project$Model_Form$updatePostForm = F2(
	function (item, post) {
		var _p0 = item;
		if (_p0.ctor === 'Title') {
			return A2(_user$project$Model_Post$title, post, _p0._0);
		} else {
			return A2(_user$project$Model_Post$body, post, _p0._0);
		}
	});
var _user$project$Model_Form$updateUserForm = F2(
	function (item, user) {
		var _p1 = item;
		if (_p1.ctor === 'Name') {
			return A2(_user$project$Model_User$name, user, _p1._0);
		} else {
			return A2(_user$project$Model_User$email, user, _p1._0);
		}
	});
var _user$project$Model_Form$update = F2(
	function (msg, model) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'UserForm':
				return {
					...
					_0: A2(
						...
						model,
						A2(_user$project$Model_Form$updateUserForm, _p2._0, model.user)),
			...
			case 'PostForm':
				return {
					...
					_0: A2(
						...
						model,
						A2(_user$project$Model_Form$updatePostForm, _p2._0, model.post)),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
...
var _user$project$Model_Form$Submit = function (a) {
...
var _user$project$Message$FormMsg = function (a) {
...
var _user$project$Routing_Route$CreateUser = {ctor: 'CreateUser'};
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_0: A2(
												_evancz$url_parser$UrlParser$map,
												_user$project$Routing_Route$CreateUser,
...
var _user$project$View_HelperView$currentPage = function (maybePagePath) {
	return A2(
...
var _user$project$View_HelperView$renderLocation = function (location) {
	return A2(
		_elm_lang$html$Html$li,
		{ctor: '[]'},
		{
...
var _user$project$View_HelperView$renderHistory = function (history) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$View_HelperView$renderLocation, history)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$View_HelperView$renderLink = function (url) {
	return A2(
		_elm_lang$html$Html$li,
		{ctor: '[]'},
		{
...
var _user$project$View_HelperView$allLinks = function (id) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('page link'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$View_HelperView$renderLink,
						{
							ctor: '::',
							_0: '/',
							_1: {
...
var _user$project$View_HelperView$renderPost = function (post) {
	return A2(
		_elm_lang$html$Html$li,
		{ctor: '[]'},
		{
			...
			_0: _elm_lang$html$Html$text(
				A2(
					_elm_lang$core$Basics_ops['++'],
					post.title,
					A2(_elm_lang$core$Basics_ops['++'], ':', post.body))),
			_1: {ctor: '[]'}
		});
};
var _user$project$View_HelperView$renderPosts = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$ul,
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$View_HelperView$renderPost, model.listPosts)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$View_HelperView$render = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$View_HelperView$notFound = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Controller_PageController$signin = function (model) {
	return {ctor: '_Tuple3', _0: model, _1: _elm_lang$core$Platform_Cmd$none, _2: _user$project$View_HelperView$render};
};
var _user$project$Controller_PageController$contact = function (model) {
	return {ctor: '_Tuple3', _0: model, _1: _elm_lang$core$Platform_Cmd$none, _2: _user$project$View_HelperView$render};
};
var _user$project$Controller_PageController$help = function (model) {
	return {ctor: '_Tuple3', _0: model, _1: _elm_lang$core$Platform_Cmd$none, _2: _user$project$View_HelperView$render};
};
var _user$project$Controller_PageController$about = function (model) {
	return {ctor: '_Tuple3', _0: model, _1: _elm_lang$core$Platform_Cmd$none, _2: _user$project$View_HelperView$render};
};
...
var _user$project$View_PostView$edit = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('post edit'),
			_1: {ctor: '[]'}
		});
};
var _user$project$View_PostView$show = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$View_PostView$new = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('post new'),
			_1: {ctor: '[]'}
		});
};

var _user$project$Controller_PostController$edit = F2(
	function (id, model) {
		return {ctor: '_Tuple3', _0: model, _1: _elm_lang$core$Platform_Cmd$none, _2: _user$project$View_PostView$edit};
	});
		...
		do {
			if (_p0.ctor === 'Show') {
				if (_p0._0.ctor === 'Success') {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$Model$updatePost, model, _p0._0._0),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					break _v0_2;
				...
				if (_p0._0.ctor === 'Success') {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$Model$updateListPosts, model, _p0._0._0),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					break _v0_2;
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Model_Form$Submit('/create-user')),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
...
var _user$project$Controller_UserController$create = function (model) {
	return {
		ctor: '_Tuple3',
		_0: model,
		_1: A2(
			...
			A2(
				_elm_lang$core$Platform_Cmd$map,
				_user$project$Request_Message$UserReq,
				_user$project$Request_UserData$signUp(model.user))),
		_2: _user$project$View_UserView$show
	};
};
...
var _user$project$Controller_UserController$update = F2(
	function (msg, model) {
		...
		if ((_p0.ctor === 'Show') && (_p0._0.ctor === 'Success')) {
			return {
				ctor: '_Tuple2',
				_0: A2(_user$project$Model$updateUser, model, _p0._0._0),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		} else {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
...
var _user$project$Resource$Param = F4(
	function (a, b, c, d) {
		return {currentPagePath: a, locationHistory: b, render: c, model: d};
	});
var _user$project$Resource$new = F2(
	function (location, renderFunc) {
		return A4(
			...
			renderFunc,
			_user$project$Model$new);
	});

var _user$project$Router$action = F2(
	function (path, model) {
		var _p0 = path;
		switch (_p0.ctor) {
			case 'NotFound':
			...
			case 'Help':
				return _user$project$Controller_PageController$help(model);
			case 'Contact':
				return _user$project$Controller_PageController$contact(model);
			case 'SignIn':
				return _user$project$Controller_PageController$signin(model);
			case 'NewPost':
...
var _user$project$Router$updateModel = F2(
...
var _user$project$Router$routing = F2(
	function (location, param) {
		...
		return {
			ctor: '_Tuple2',
			_0: A2(
				_user$project$Router$updateRender,
				render,
				A2(
					_user$project$Router$updateModel,
					model,
					A2(_user$project$Router$updatePath, location, param))),
			_1: cmd
		};
	});
...
var _user$project$Endpoint$view = function (param) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: param.render(param.model),
			_1: {
				ctor: '::',
				_0: _user$project$View_HelperView$currentPage(param.currentPagePath),
				_1: {
					ctor: '::',
					_0: _user$project$View_HelperView$allLinks(1),
					_1: {
						ctor: '::',
						_0: _user$project$View_HelperView$renderHistory(param.locationHistory),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Endpoint$update = F2(
	function (msg, param) {
		...
		switch (_p0.ctor) {
			...
			default:
				var _p1 = A2(_user$project$Model_Form$update, _p0._0, param.model);
				var model = _p1._0;
				var cmd = _p1._1;
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Resource$updateModel, param, model),
					_1: cmd
				};
		}
	});
...
var _user$project$Endpoint$main = A2(
	...
	{init: _user$project$Endpoint$init, view: _user$project$Endpoint$view, update: _user$project$Endpoint$update, subscriptions: _user$project$Endpoint$subscriptions})();

var Elm = {};
Elm['Endpoint'] = Elm['Endpoint'] || {};
if (typeof _user$project$Endpoint$main !== 'undefined') {
    _user$project$Endpoint$main(Elm['Endpoint'], 'Endpoint', undefined);
}
